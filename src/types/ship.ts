...
export const ships: Ship[] = [
  // Fighters (all 1 CP)
  { id: "at021-pulse", name: "AT021 - Pulse Attacker", shipClass: "Fighter", tier: "A", cp: 1 },
  { id: "at021-tactical", name: "AT021 - Tactical Attacker", shipClass: "Fighter", tier: "B", cp: 1 },
  { id: "at021-heavy", name: "AT021 - Heavy Attacker", shipClass: "Fighter", tier: "A", cp: 1 },
  { id: "b192-newland", name: "B192 Newland - Heavy Attacker", shipClass: "Fighter", tier: "C", cp: 1 },
  { id: "balancer-sc020", name: "Balancer Anderson SC020 - Scout", shipClass: "Fighter", tier: "B", cp: 1 },
  { id: "bullfrog-bomber", name: "Bullfrog - Dual-Purpose Bomber", shipClass: "Fighter", tier: "C", cp: 1 },
  { id: "hayreddin-loyal", name: "Hayreddin's Loyal - Pulsar Fighter", shipClass: "Fighter", tier: "B", cp: 1 },
  { id: "janbiya-aer410", name: "Janbiya Aer410 - Assault Attacker", shipClass: "Fighter", tier: "D", cp: 1 },
  { id: "mistral-combat", name: "Mistral - Combat Attacker", shipClass: "Fighter", tier: "S", cp: 1 },
  { id: "sandrake-interceptor", name: "Sandrake - Atmospheric Interceptor", shipClass: "Fighter", tier: "B", cp: 1 },
  { id: "sc002-quantum", name: "SC002 - Quantum Scout", shipClass: "Fighter", tier: "B", cp: 1 },
  { id: "spore-a404", name: "Spore A404 - Light Fighter", shipClass: "Fighter", tier: "A", cp: 1 },
  { id: "stingray-torpedo", name: "Stingray - Torpedo Bomber", shipClass: "Fighter", tier: "A", cp: 1 },
  { id: "strix-a100", name: "Strix A100 - Joint Attacker", shipClass: "Fighter", tier: "A", cp: 1 },
  { id: "vitas-a021", name: "Vitas A021 - Heavy Attacker", shipClass: "Fighter", tier: "A", cp: 1 },
  { id: "vitas-b010", name: "Vitas-B010 - Bomber", shipClass: "Fighter", tier: "S", cp: 1 },

  // Corvettes (all 2 CP)
  { id: "cellular-defender", name: "Cellular Defender - Heavy Torpedo Corvette", shipClass: "Corvette", tier: "S", cp: 2 },
  { id: "cv-ii003", name: "CV-II003 - Light Corvette", shipClass: "Corvette", tier: "D", cp: 2 },
  { id: "cv-m011-missile", name: "CV-M011 - Heavy Missile Corvette", shipClass: "Corvette", tier: "B", cp: 2 },
  { id: "cv-m011-cannon", name: "CV-M011 - Heavy Cannon Corvette", shipClass: "Corvette", tier: "C", cp: 2 },
  { id: "cv-m011-highspeed", name: "CV-M011 - High Speed Missile Corvette", shipClass: "Corvette", tier: "A", cp: 2 },
  { id: "cv-t800", name: "CV-T800 - Pulsar Corvette", shipClass: "Corvette", tier: "S", cp: 2 },
  { id: "nebula-heavy", name: "Nebula Chaser - Heavy Corvette", shipClass: "Corvette", tier: "B", cp: 2 },
  { id: "nebula-pulsar", name: "Nebula Chaser - Pulsar Corvette", shipClass: "Corvette", tier: "A", cp: 2 },
  { id: "redbeast-713", name: "RedBeast 7-13 - Missile Corvette", shipClass: "Corvette", tier: "A", cp: 2 },
  { id: "s-levy9", name: "S-Levy9 - Heavy Torpedo Escort Corvette", shipClass: "Corvette", tier: "A", cp: 2 },
  { id: "silent-assassin", name: "Silent Assassin - Armored Corvette", shipClass: "Corvette", tier: "C", cp: 2 },
  { id: "void-elfin", name: "Void Elfin - Stealth Missile Corvette", shipClass: "Corvette", tier: "A", cp: 2 },
  ...
  { id: "winged-hussar-aa", name: "Winged Hussar - Area-Denial Anti-Aircraft Destroyer", shipClass: "Destroyer", tier: "S", cp: 6 },
  ...
  { id: "eternal-storm", name: "Eternal Storm - Attack Battlecruiser", shipClass: "Battlecruiser", tier: "B", cp: 32 },
